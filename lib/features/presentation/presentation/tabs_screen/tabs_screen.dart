...
import 'package:joel_s_application10/features/presentation/presentation/collection_dialog/controller/collection_controller.dart';
...
class TabsScreen extends GetWidget<TabsController> {
    ...
    return Container(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
          ...
          CustomImageView(
              ...
              height: /*40.*/ 40.adaptSize,
              width: 40.adaptSize), //40
          CustomImageView(
              imagePath: ImageConstant.imgUser,
              height: 40.adaptSize, //40
              width: 40.adaptSize, //40
              onTap: () {
                onTapImgUser();
                print('Home');
  ...
  Widget _buildTabsContestants() {
    return Container(
        width: double.maxFinite,
        padding: EdgeInsets.symmetric(vertical: 19.v), //15
        decoration: AppDecoration.gradientGrayToWhiteA,
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
          CustomImageView(
